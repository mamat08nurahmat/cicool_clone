define({ "api": [{
  ...
  },
  {
        ...
        "Header": [
          {
            ...
            "optional": false,
            "field": "X-Api-Key",
            "description": "<p>Persons unique access-key.</p>"
          }
                  ]
      }
    },
    "permission": [
      {
        "name": "Persons Cant be Accessed permission name : api_persons_add"
      }
    ],
    "parameter": {
      "fields": {
        "Parameter": [
            ...
            "optional": false,
            "field": "LastName",
            "description": "<p>Mandatory LastName of Personss Input LastName Max Length : 255..</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "FirstName",
            "description": "<p>Mandatory FirstName of Personss Input FirstName Max Length : 255..</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "Age",
            "description": "<p>Mandatory Age of Personss Input Age Max Length : 11..</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "Image",
            "description": "<p>Mandatory image of Personss .</p>"
          }
        ]
      }
    },
    ...
    "filename": "application/controllers/api/Persons.php",
    "groupTitle": "Persons"
  },
  {
    "type": "get",
    "url": "/persons/all",
    "title": "Get all Personss.",
    "version": "0.1.0",
    "name": "Allpersons",
    "group": "persons",
    "header": {
        ...
        "Header": [
          {
            ...
            "optional": false,
            "field": "X-Api-Key",
            "description": "<p>Personss unique access-key.</p>"
          },
          {
            "group": "Header",
            "type": "String",
            "optional": false,
            "field": "X-Token",
            "description": "<p>Personss unique token.</p>"
          }
        ]
      }
    },
    "permission": [
      {
        "name": "{} Cant be Accessed permission name : api_Persons_all"
      }
    ],
    "parameter": {
      "fields": {
        "Parameter": [
         
          {
            ...
            "field": "Field",
            "defaultValue": "All Field",
            "description": "<p>Optional field of Personss.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "field": "Start",
            "defaultValue": "0",
            "description": "<p>Optional start index of Personss.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "field": "Limit",
            "defaultValue": "10",
            "description": "<p>Optional limit data of Personss.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "Data",
            "description": "<p>data of Persons.</p>"
          }
        ]
      },
      "examples": [
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "NoDataPersons",
            "description": "<p>Persons data is nothing.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "permission": [
      {
        "name": "Persons Cant be Accessed permission name : api_Persons_delete"
      }
    ],
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "Id",
            "description": "<p>Mandatory id of Personss .</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "permission": [
      {
        "name": "Persons Cant be Accessed permission name : api_Persons_detail"
      }
    ],
    "parameter": {
      "fields": {
        ...
        "Error 4xx": [
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "PersonsNotFound",
            "description": "<p>Persons data is not found.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "permission": [
      {
        "name": "Persons Cant be Accessed permission name : api_Persons_update"
      }
    ],
    "parameter": {
      "fields": {
