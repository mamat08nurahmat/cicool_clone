   ...
   <section class="doc-content">
      <div class="container">
         ...
         <div class="docs-content">
            ...
            <p>
               After you create a REST API you can directly view  the documentation that automatically created <a href="<?= site_url('administrator/doc/api'); ?>">See API Documentations</a>.
               <br>
            ...
            <p>
               to get tokens you can see more at documentation,  <a href="<?= site_url('administrator/doc/api'); ?>">See API Documentations</a>.
               <br>
               or you can visit <a href="<?= site_url('administrator/rest/tool/get-token'); ?>">this link</a> there you can get a token directly by following the instructions provided.
            </p>
